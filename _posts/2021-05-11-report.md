...
- The device does not need to reconstruct the initial signal (so compliance with Shannon's Theorem is not essential);
- The size in terms of bytes of the acquired signal may increase due to the increased number of samples.
...
<p align="right" width="110%">
    <img width="75%" src="https://github.com/freshq99/freshq99.github.io/blob/master/assets/img/ReportMetroBS/boxplot_std.png"> 
    <p align="right">Figure 4: Boxplot of standard deviationsin a group of 22 backward falls, relativeto the x-axis of the accelerometer.<p align="right">
</p>
